...
export type Ipayload = Record<string, string | Array<Record<string, unknown>> | boolean | Date | number | Record<string, unknown>> | Record<string, string | Array<Record<string, unknown>> | boolean | number | Record<string, unknown> | typeof Date>[]
